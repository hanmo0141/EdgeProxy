...
/** 解析 VLESS 请求 */
export function parseVLESSRequest(chunk: Uint8Array | ArrayBuffer, uuid: string): VLESSRequest | { hasError: true; message: string } {
...
/** 检查是否是 VLESS 首包 */
export function isVLESSPacket(data: Uint8Array, uuid: string): boolean {
